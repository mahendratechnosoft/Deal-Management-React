              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                <div className="space-y-2">
                  ...
                  <input
                    ...
                    value={formData.code}
                    onChange={handleChange}
                    className={`w-full px-3 py-2 border rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all duration-200 ${errors.code ? "border-red-500" : "border-gray-300"
                      }`}
                ...
                <div className="space-y-2">
                  ...
                  <div className="relative">
                    <input
                      ...
                      onChange={handleChange}
                      min="0"
                      className={`w-full px-3 py-2 border rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all duration-200 ${errors.quantity ? "border-red-500" : "border-gray-300"
                        }`}
                      placeholder="0"
                    />
                ...
                <div className="space-y-2">
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      min="0"
                      step="0.01"
                      className={`w-full pl-8 pr-3 py-2 border rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all duration-200 ${errors.rate ? "border-red-500" : "border-gray-300"
                        }`}
                      placeholder="0.00"
                    />
                  </div>
