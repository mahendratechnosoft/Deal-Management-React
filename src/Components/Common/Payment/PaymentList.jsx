                                                        ...
                                                        <div>
                                                            ...
                                                            <div className="flex items-center gap-1 opacity-0 group-hover:opacity-100 transition-all duration-200">
                                                                ...
                                                                {/* <button
                                                                    onClick={(e) => {
                                                                        e.stopPropagation();
                                                                        handleView(payment.paymentId);
                                                                    }}
                                                                    className="text-blue-600 hover:text-blue-900 hover:bg-blue-50 rounded-lg transition-all duration-200 flex items-center gap-1 text-xs bg-white"
                                                                ...
                                                                <button
                                                                    ...
                                                                    className="text-green-600 hover:text-green-900 hover:bg-green-50 rounded-lg transition-all duration-200 flex items-center gap-1 text-xs bg-white px-2"
                                                                >
                                                                    <svg
                                                                        className="w-3 h-3"
                                                                        fill="none"
