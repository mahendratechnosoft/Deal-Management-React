...
// Adjust the import path to where you saved your custom components
import {
  FormInput,
  FormSelect,
  FormFileAttachment,
...
const CreatePaymentProfileModal = ({ isOpen, onClose, onSuccess }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await axiosInstance.post("createPaymentProfile", formData);
      onSuccess();
      onClose();
      setFormData({
        profileName: "",
      ...
      setError("Failed to create payment profile.");
    } finally {
      setLoading(false);
    }
  };
...
export default CreatePaymentProfileModal;
