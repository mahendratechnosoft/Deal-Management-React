  ...
  useEffect(() => {
    const fetchFinanceSettings = async () => {
      try {
        ...
        setFinanceSettings({ ...data, type: "PROFORMA" });
      } catch (error) {
        ...
        <div className="flex flex-col lg:flex-row lg:items-start lg:justify-between gap-4">
          <div className="flex-1">
            <div className="flex items-center gap-3 mb-2">
              ...
              <div>
                <h1 className="text-2xl font-bold text-gray-900">Proforma</h1>
                <p className="text-gray-600 text-sm mt-1">
                  Manage your proforma settings
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="flex flex-wrap gap-6">
              ...
              <label className="flex items-center gap-2 cursor-pointer group">
                <input
                  ...
                  checked={financeSettings.numberFormat === "FINANCIAL_YEAR"}
                  onChange={handleInfoChange}
                  className="w-4 h-4 text-blue-600 border-gray-300 focus:ring-blue-500 cursor-pointer"
                />
                <span className="text-sm text-gray-700 group-hover:text-gray-900">
