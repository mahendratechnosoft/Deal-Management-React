...
function HandoverDocsPDF() {
  ...
  const generateDonorReportPDF = () => {
    try {
      ...
      // Sub Header
      doc.setFontSize(14);
      doc.text("ASHWINI HOSPITAL, ART BANK", pageWidth / 2, yPos, {
        align: "center",
      });
      yPos += 5;
      ...
      // Contact Information
      doc.text(
        `Phone: ${donorData.phone} | Web: ${donorData.website}`,
        pageWidth / 2,
        yPos,
        { align: "center" }
      );
      ...
      doc.text("FROZEN DONOR SEMEN REPORT", pageWidth - margin, yPos, {
        align: "right",
      });
      yPos += 8;
      ...
      familyCols.forEach((col, index) => {
        doc.text(
          col,
          familyStartX + familyColWidth * index + familyColWidth / 2,
          yPos + 5,
          { align: "center" }
        );
      });
      ...
      doc.setFont("helvetica", "normal");
      doc.text(
        donorData.brother.age,
        familyStartX + familyColWidth + familyColWidth / 2,
        yPos + rowHeight / 2 + 2,
        { align: "center" }
      );
      doc.text(
        donorData.brother.profession,
        familyStartX + familyColWidth * 2 + familyColWidth / 2,
        yPos + rowHeight / 2 + 2,
        { align: "center" }
      );
      doc.text(
        donorData.brother.kids,
        familyStartX + familyColWidth * 3 + familyColWidth / 2,
        yPos + rowHeight / 2 + 2,
        { align: "center" }
      );
      doc.text(
        donorData.brother.illness,
        familyStartX + familyColWidth * 4 + familyColWidth / 2,
        yPos + rowHeight / 2 + 2,
        { align: "center" }
      );
      ...
      doc.setFont("helvetica", "normal");
      doc.text(
        donorData.sister.age,
        familyStartX + familyColWidth + familyColWidth / 2,
        yPos + rowHeight / 2 + 2,
        { align: "center" }
      );
      doc.text(
        donorData.sister.profession,
        familyStartX + familyColWidth * 2 + familyColWidth / 2,
        yPos + rowHeight / 2 + 2,
        { align: "center" }
      );
      doc.text(
        donorData.sister.kids,
        familyStartX + familyColWidth * 3 + familyColWidth / 2,
        yPos + rowHeight / 2 + 2,
        { align: "center" }
      );
      doc.text(
        donorData.sister.illness,
        familyStartX + familyColWidth * 4 + familyColWidth / 2,
        yPos + rowHeight / 2 + 2,
        { align: "center" }
      );
      ...
      semenCols.forEach((col, index) => {
        doc.text(
          col,
          semenStartX + semenColWidth * index + semenColWidth / 2,
          yPos + 5,
          { align: "center" }
        );
      });
      ...
      doc.rect(
        ...
        yPos - rowHeight,
        semenColWidth * 3,
        rowHeight * (donorData.semenAnalysis.parameters.length + 1)
      );
      ...
      donorData.semenAnalysis.parameters.forEach((param, index) => {
        ...
        doc.text(
          param.result,
          semenStartX + semenColWidth + semenColWidth / 2,
          currentY + rowHeight / 2 + 2,
          { align: "center" }
        );
        doc.text(
          param.unit,
          semenStartX + semenColWidth * 2 + semenColWidth / 2,
          currentY + rowHeight / 2 + 2,
          { align: "center" }
        );
      });
      ...
      doc.text(donorData.hospitalName, pageWidth / 2, yPos, {
        align: "center",
      });
      ...
      doc.text(
        "This is a computer-generated report. No physical signature required.",
        pageWidth / 2,
        footerY,
        { align: "center" }
      );
      ...
      // ==================== SAVE PDF ====================
      const fileName = `Donor_Report_${
        donorData.sampleId
      }_${donorData.reportDate.replace(/\//g, "-")}.pdf`;
      doc.save(fileName);
            ...
            <div className="flex items-center space-x-4">
              ...
              <div>
                <h1 className="text-2xl font-bold text-white">
                  Donor Semen Report Generator
                </h1>
                <p className="text-blue-100 mt-1">
                  Generate professional donor semen analysis reports
                </p>
              </div>
            </div>
            ...
            <div className="bg-gradient-to-br from-gray-50 to-white border border-gray-200 rounded-xl p-6 shadow-lg">
              ...
              <div className="space-y-4">
                ...
                <div className="bg-green-50 p-4 rounded-lg border border-green-100">
                  ...
                  <div className="grid grid-cols-2 gap-2 text-sm">
                    <div>
                      <span className="text-gray-600">HIV I & II:</span>{" "}
                    ...
                    <div>
                      <span className="text-gray-600">VDRL:</span>{" "}
                      <span className="text-green-600 font-medium">
                        {donorData.vdrl}
                      </span>
                    </div>
                  ...
                  <div className="text-sm">
                    <div className="flex justify-between mb-1">
                      ...
                      <span className="font-medium">
                        {donorData.semenAnalysis.parameters[0].result}{" "}
                        {donorData.semenAnalysis.parameters[0].unit}
                      </span>
                    </div>
                    <div className="flex justify-between mb-1">
                      <span className="text-gray-600">
                      ...
                      <span className="font-medium">
                        {donorData.semenAnalysis.parameters[1].result}%
                      </span>
                    </div>
                    <div className="flex justify-between">
                      <span className="text-gray-600">Normal Morphology:</span>
                      <span className="font-medium">
                        {donorData.semenAnalysis.parameters[5].result}%
                      </span>
                    </div>
                  </div>
                </div>
                ...
                <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4">
                  <div className="flex items-start">
                    ...
                    <div className="text-sm text-yellow-700">
                      <span className="font-medium">Note:</span> This report
                      includes all mandatory medical disclosures and testing
                      declarations as per ART guidelines.
                    </div>
                  </div>
                </div>
              </div>
