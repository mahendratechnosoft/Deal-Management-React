...
import {
  ...
  FormSelect,
  FormTextarea,
} from "../../BaseComponet/CustomeFormComponents"; // Adjust path if needed
import axiosInstance from "../../BaseComponet/axiosInstance"; // Adjust path if needed
...
const validateAdhar = (adhar) => {
  if (!adhar) return "Adhar Card number is required";
...
const CreateSemenEnquiry = ({ isOpen, onClose, onSuccess }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const apiDataPayload = {
        ...
        phoneNumber: formData.mobile, // Mapped to API field
        email: formData.email,
        height: Number(formData.height),
        weight: Number(formData.weight),
        adharCardNo: formData.adharCardNo, // New API field
      ...
      // 3. Send Request
      await axiosInstance.post("createSemenEnquiry", apiDataPayload);
      ...
      const errMsg =
        ...
        "Error creating enquiry. Please try again.";
      toast.error(errMsg);
    } finally {
          ...
          <form onSubmit={handleSubmit} className="space-y-8">
            ...
            <div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                {/* Adhar Card No (New Field) */}
                {renderFormInput({
                  label: "Adhar Card No",
                  name: "adharCardNo",
                  type: "text",
                  placeholder: "Enter 12-digit Adhar No",
                })}
...
export default CreateSemenEnquiry;
