...
const CreateFamily = ({ isOpen, onClose, onSuccess, donorId }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const msg =
        error.response?.data?.message || "Error creating family information.";
      toast.error(msg);
    } finally {
      ...
      <div className="bg-white w-full max-w-6xl rounded-2xl shadow-2xl overflow-hidden flex flex-col max-h-[90vh]">
          ...
          <div>
            ...
            {donorId && (
              <span className="text-sm text-gray-500 mt-1 inline-block">
                Linking to Donor ID:{" "}
                <span className="font-medium text-gray-700">{donorId}</span>
              </span>
            )}
          </div>
        </div>
        ...
        <div className="overflow-y-auto p-6 flex-grow bg-gray-50">
          ...
          >
            ...
            <div className="bg-white p-6 rounded-xl border border-gray-200 shadow-sm">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <FormInput
                  ...
                  value={formData.referHospitalAddress}
                  onChange={handleChange}
                  type="text"
                ...
                <FormInput
                  ...
                  value={formData.referDoctorContactNumber}
                  onChange={handleChange}
                  type="text"
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <FormSelect
                  ...
                  value={bloodGroupOptions.find(
                    (o) => o.value === formData.husbandBloodGroup
                  )}
                  onChange={(option) =>
                    handleSelectChange(option, { name: "husbandBloodGroup" })
                  }
                ...
                <FormSelect
                  ...
                  value={skinColorOptions.find(
                    (o) => o.value === formData.husbandSkinColor
                  )}
                  onChange={(option) =>
                    handleSelectChange(option, { name: "husbandSkinColor" })
                  }
                ...
                <FormSelect
                  ...
                  value={eyeColorOptions.find(
                    (o) => o.value === formData.husbandEyeColor
                  )}
                  onChange={(option) =>
                    handleSelectChange(option, { name: "husbandEyeColor" })
                  }
                ...
                <FormSelect
                  ...
                  value={educationOptions.find(
                    (o) => o.value === formData.husbandEducation
                  )}
                  onChange={(option) =>
                    handleSelectChange(option, { name: "husbandEducation" })
                  }
            ...
            {/* Wife Information */}
            <div className="bg-white p-6 rounded-xl border border-gray-200 shadow-sm">
              <h3 className="text-lg font-semibold text-pink-800 mb-4 border-b pb-2">
                Wife Information
              </h3>
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <FormInput
                ...
                <FormSelect
                  ...
                  name="wifeBloodGroup"
                  value={bloodGroupOptions.find(
                    (o) => o.value === formData.wifeBloodGroup
                  )}
                  onChange={(option) =>
                    handleSelectChange(option, { name: "wifeBloodGroup" })
                  }
                  options={bloodGroupOptions}
                />
                <FormSelect
                  ...
                  name="wifeSkinColor"
                  value={skinColorOptions.find(
                    (o) => o.value === formData.wifeSkinColor
                  )}
                  onChange={(option) =>
                    handleSelectChange(option, { name: "wifeSkinColor" })
                  }
                  options={skinColorOptions}
                />
                ...
                <FormSelect
                  ...
                  name="wifeEyeColor"
                  value={eyeColorOptions.find(
                    (o) => o.value === formData.wifeEyeColor
                  )}
                  onChange={(option) =>
                    handleSelectChange(option, { name: "wifeEyeColor" })
                  }
                  options={eyeColorOptions}
                  placeholder="Select Eye Color"
                />
                ...
                <FormSelect
                  ...
                  name="wifeEducation"
                  value={educationOptions.find(
                    (o) => o.value === formData.wifeEducation
                  )}
                  onChange={(option) =>
                    handleSelectChange(option, { name: "wifeEducation" })
                  }
                  options={educationOptions}
                />
