          ...
          <div className="flex flex-col lg:flex-row lg:items-start lg:justify-between gap-4">
            <div className="flex-1">
              <div className="flex items-center gap-3 mb-2">
                ...
                <div>
                  <h1 className="text-2xl font-bold text-gray-900">Family List</h1>
                </div>
              </div>
            </div>
          ...
          <div className="flex-grow overflow-auto">
            <table className="min-w-full divide-y divide-gray-200 table-fixed">
              <thead className="bg-gray-50 sticky top-0 z-10">
                <tr>
                  <th className="w-[15%] px-4 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">UIN</th>
                  <th className="w-[15%] px-4 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Husband Name</th>
                  <th className="w-[15%] px-4 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Wife Name</th>
                  <th className="w-[20%] px-4 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Refer Hospital</th>
                  <th className="w-[15%] px-4 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Refer Doctor</th>
              ...
              <tbody className="bg-white divide-y divide-gray-200">
                {loading ? (
                  ...
                  familyList.map((family) => (
                    <tr key={family.familyInfoId} className="hover:bg-gray-50 transition-colors">
                      <td className="px-4 py-4 truncate text-sm text-gray-900 font-medium">{family.uin || "-"}</td>
                      <td className="px-4 py-4 truncate text-sm text-gray-900 font-bold">{family.husbandName}</td>
