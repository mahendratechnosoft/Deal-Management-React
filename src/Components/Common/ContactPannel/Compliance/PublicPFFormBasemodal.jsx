// PublicPFFormBasemodal.jsx
import React, { useState } from "react";
import toast from "react-hot-toast";

function PublicPFFormBasemodal({ generatedLink, onClose, onCopyLink }) {
        ...
        <div className="p-6">
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-green-700 text-sm mt-1">
                  ...
                  use this link to submit their PF details.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
            ...
            <ol className="list-decimal pl-5 space-y-2 text-sm text-blue-700">
              ...
              <li>The employee will fill their PF details in the form</li>
              <li>
                Submitted data will automatically sync with your PF records
              </li>
              <li>You can view the submitted data in the PF section</li>
            </ol>
          </div>
        </div>
...
export default PublicPFFormBasemodal;
