...
import EditEsicModal from "./Esic/EditEsicModal"; // Import the Edit ESIC modal
...
function ComplianceList() {
  ...
  const [showEditEsicModal, setShowEditEsicModal] = useState(false); // ESIC edit modal state
  const [selectedPFId, setSelectedPFId] = useState(null);
  const [selectedEsicId, setSelectedEsicId] = useState(null); // ESIC ID state
  ...
  // Fetch PF data with pagination and search
  ...
  // Fetch ESIC data with pagination and search
