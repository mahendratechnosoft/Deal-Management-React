                        ...
                        <div className="lg:col-span-2 space-y-4">
                            <div className="bg-white rounded-lg border border-gray-200 p-4">
                                <div className="flex items-center gap-2 mb-4">
                                    ...
                                    <h2 className="text-base font-semibold text-gray-900">Admin Information</h2>
                                </div>
                            ...
                            <div className="bg-white rounded-lg border border-gray-200 p-4">
                                ...
                                <div className="space-y-2">
                                    <ModuleAccessToggle
                                        ...
                                        onChange={(isChecked) => handleAccessChange("leadAccess", isChecked)}
                                    />
                                    ...
                                    <ModuleAccessToggle
                                        ...
                                        onChange={(isChecked) => handleAccessChange("customerAccess", isChecked)}
                                    />
                                    ...
                                    <ModuleAccessToggle
                                        ...
                                        onChange={(isChecked) => handleAccessChange("proposalAccess", isChecked)}
                                    />
                                    ...
                                    <ModuleAccessToggle
                                        ...
                                        onChange={(isChecked) => handleAccessChange("proformaInvoiceAccess", isChecked)}
                                    />
                                    ...
                                    <ModuleAccessToggle
                                        ...
                                        onChange={(isChecked) => handleAccessChange("invoiceAccess", isChecked)}
                                    />
                                    ...
                                    <ModuleAccessToggle
                                        ...
                                        onChange={(isChecked) => handleAccessChange("paymentAccess", isChecked)}
                                    />
                                    ...
                                    <ModuleAccessToggle
                                        ...
                                        onChange={(isChecked) => handleAccessChange("timeSheetAccess", isChecked)}
                                    />
                                </div>
                            </div>
                        </div>
        ...
        <div className="flex items-center justify-between p-2 border border-gray-200 rounded bg-gray-50 hover:bg-gray-100 transition-colors">
            ...
            <label className="flex items-center cursor-pointer">
                <div className="relative">
                    ...
                    />
                    <div
                        className={`block w-10 h-5 rounded-full transition-colors ${isChecked ? "bg-blue-600" : "bg-gray-300"
                            }`}
                    ></div>
                    <div
                        className={`absolute left-0.5 top-0.5 w-4 h-4 bg-white rounded-full transition-transform transform ${isChecked ? "translate-x-5" : "translate-x-0"
                            }`}
                    ></div>
                </div>
            </label>
